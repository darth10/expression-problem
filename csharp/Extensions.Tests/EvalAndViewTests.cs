...
namespace Extensions.Tests
{
    public class EvalAndViewTests
    {
        ...
        [Fact]
        public void AddEvalTest2() =>    // fails
            Assert.Throws<NotImplementedException>(() => _addExpr2.Eval());
        ...
        [Fact]
        public void AddViewTest2() =>    // fails
            Assert.Throws<NotImplementedException>(() => _addExpr2.View());
    }
}
